...
// BorrowFixedIP provides a mock function with given fields: _a0, _a1, _a2
func (_m *FixedIPAllocator) BorrowFixedIP(_a0 context.Context, _a1 types.IP, _a2 types.Container) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.IP, types.Container) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
// ReturnFixedIP provides a mock function with given fields: _a0, _a1, _a2
func (_m *FixedIPAllocator) ReturnFixedIP(_a0 context.Context, _a1 types.IP, _a2 types.Container) error {
	ret := _m.Called(_a0, _a1, _a2)
...
// UnallocFixedIP provides a mock function with given fields: _a0, _a1, _a2
func (_m *FixedIPAllocator) UnallocFixedIP(_a0 context.Context, _a1 types.IP, _a2 bool) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.IP, bool) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
