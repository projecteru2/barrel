...
) (AddressManager, pluginNetwork.Driver) {
	ipam := &ipamDriver{
...
// RunNetworkPluginService .
func RunNetworkPluginService(driverName string, ipam pluginIPAM.Ipam, net pluginNetwork.Driver) error {
